...
function Home() {
  ...
  return (
    <div className='flex justify-between min-w-full md:min-w-[550px] md:max-w-[65%] px-2 h-[95%] md:h-full rounded-xl shadow-lg
    bg-gray-600 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0 '>
